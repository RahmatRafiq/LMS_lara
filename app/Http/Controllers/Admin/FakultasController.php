...
class FakultasController extends Controller
{
    ...
    public function store(FakultasRequest $request)
    {
        ...
        return redirect(route('fakultas.index'))->with('success', 'Berhasil menyimpan data Sekolah');
    }
    ...
    public function update(FakultasRequest $request, Fakultas $fakulta)
    {
        ...
        return redirect(route('fakultas.index'))->with('success', 'Berhasil update data Sekolah');
    }

    public function destroy(Fakultas $fakulta)
    {
        $fakulta->delete();
        return back()->with('success', 'Berhasil hapus data Sekolah');
    }
}
