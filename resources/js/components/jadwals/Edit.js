...
function Edit(props) {
    ...
    const getDosenBySelectedKelas = async (e) => {
        ...
        let response = await axios.get(
            `/jadwals/get-dosen-by-${e.target.value}`
        );
    ...
    const getMatkulBySelectedDosen = async (e) => {
        ...
        let response = await axios.get(
            `/jadwals/get-matkul-by-${e.target.value}`
        );
    ...
    const getJadwal = async () => {
        ...
        let matkul = await axios.get(
            `/jadwals/get-matkul-by-${jadwal.dosen_id}`
        );
                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        <form onSubmit={update}>
                            ...
                            {dosens.length ? (
                                <div className="form-group">
                                    <label htmlFor="dosen">Guru</label>
                                    <select
                                        value={dosenId}
