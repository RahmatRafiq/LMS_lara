    ...
    <div class="card">
        ...
        <div class="card-body col-md-8 col-sm">
            ...
            <form action="{{ route('dosens.update', $dosen) }}" method="post" enctype="multipart/form-data">
                ...
                <x-select2 :isSelected="$dosen->matkuls" label="Mengajar Mata Pelajaran" attr="matkul" :dataArray="$matkuls"
                    valueOption="id" labelOption="nm_matkul" />
                <x-select2 :isSelected="$dosen->kelas" label="Mengajar Kelas" attr="kelas" :dataArray="$kelas" valueOption="id"
