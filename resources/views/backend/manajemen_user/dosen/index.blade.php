        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h4>Tabel Guru</h4>
                    <a href="{{ route('dosens.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus"></i>
                        Tambah guru</a>
                </div>
                <div class="card-body">
                    <x-alert />
                    ...
                    columns: [
                        ...
                        // { data: 'checkbox', orderable: false, searchable: false}
                        {
                            ...
                            "render": function(data, type, row) {
                                // console.log(row.id);
                                var html =
                                    "<input type='checkbox' name='nip[]' class='chk_boxes1' value=" +
                                    data + ">"
                                return html
                            }
                        },
